...
{{-- CONTENIDO2 --}}
@section('contenido2')
<h1>Ver Todos los Datos del Periodo</h1>
<form action="{{route('periodos.destroy', $periodo)}}" method="POST">
  @csrf

  <!-- ID del Periodo -->
  <div class="row mb-3">
    <label for="id" class="col-sm-3 col-form-label">ID del Periodo</label>
    <div class="col-sm-9">
  ...
  <!-- Nombre del Periodo -->
  <div class="row mb-3">
    <label for="periodo" class="col-sm-3 col-form-label">Nombre del Periodo</label>
    <div class="col-sm-9">
